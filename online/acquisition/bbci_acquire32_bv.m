...
%
% SYNPOSIS
%    state = bbci_acquire32_bv('init', state)                      [init]
%    state = bbci_acquire_sigserv('init', param1, value1, 
%                                         param2, value2, ...)   [init]
%    
%    [data, markertime, markerdescr, state] 
%        = bbci_acquire32_bv(state)                                [get data]
%    bbci_acquire32_bv('close')                                    [close]
%    
% ARGUMENTS
...
%
% DESCRIPTION
%    Conenct to a brainserver and retrieve data. bbci_acquire32_bv starts
...
%
%           params = struct;
%           state = bbci_acquire32_bv('init',params)
%       
