...
props= {'SyncMarker'    100            '!INT[1]'
        'ResultSuffix'  'merged'       '!CHAR'
    };
...
sync_marker_idx = find(bv_MRK.event.desc == params.SyncMarker, 1);
...
file_writeBV([bv_file_name params.ResultSuffix], bv_CNT, bv_MRK, 'Unit', bv_HDR.unitOfClab);
